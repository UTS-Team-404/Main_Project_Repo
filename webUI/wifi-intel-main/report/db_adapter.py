...
def connect_db(host, user, password, database, port=3306):
    ...
    return mc.connect(
        ...
        user=user or "team404user",
        password=password or "pass",
        database=database or "team404",
        port=port or 3306,
        auth_plugin="mysql_native_password",
        use_pure=True,  # pure-Python connector; avoids some plugin auto-switching
    )
